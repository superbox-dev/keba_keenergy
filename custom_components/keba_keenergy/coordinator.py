        ...
        try:
            ...
            response: dict[str, ValueResponse] = await self.api.read_data(
                request=[
                    ...
                    HeatPump.STATE,
                    HeatPump.ELECTRICAL_POWER,
                    HeatPump.HEATING_POWER,
                    HeatPump.HOT_WATER_POWER,
                    HeatPump.COP,
                    HeatPump.HEATING_ENERGY,
                    HeatPump.HEATING_ELECTRICAL_ENERGY,
                    HeatPump.HEATING_SPF,
                    HeatPump.COOLING_ENERGY,
                    HeatPump.COOLING_ELECTRICAL_ENERGY,
                    HeatPump.COOLING_SPF,
                    HeatPump.DOMESTIC_HOT_WATER_ENERGY,
                    HeatPump.DOMESTIC_HOT_WATER_ELECTRICAL_ENERGY,
                    HeatPump.DOMESTIC_HOT_WATER_SPF,
                    HeatPump.TOTAL_ENERGY,
                    HeatPump.TOTAL_ELECTRICAL_ENERGY,
                    HeatPump.SPF,
