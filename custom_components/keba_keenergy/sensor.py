...
SENSOR_TYPES: dict[str, tuple[KebaKeEnergySensorEntityDescription, ...]] = {
    ...
    SectionPrefix.HEAT_PUMP: (
        ...
        KebaKeEnergySensorEntityDescription(
            device_class=SensorDeviceClass.ENERGY,
            entity_registry_enabled_default=False,
            key="heating_electrical_energy",
            native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
            state_class=SensorStateClass.TOTAL_INCREASING,
            translation_key="heating_electrical_energy",
            value=lambda data: cast("float", data),
        ),
        KebaKeEnergySensorEntityDescription(
            entity_registry_enabled_default=False,
        ...
        KebaKeEnergySensorEntityDescription(
            device_class=SensorDeviceClass.ENERGY,
            entity_registry_enabled_default=False,
            key="cooling_electrical_energy",
            native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
            state_class=SensorStateClass.TOTAL_INCREASING,
            translation_key="cooling_electrical_energy",
            value=lambda data: cast("float", data),
        ),
        KebaKeEnergySensorEntityDescription(
            entity_registry_enabled_default=False,
        ...
        KebaKeEnergySensorEntityDescription(
            device_class=SensorDeviceClass.ENERGY,
            entity_registry_enabled_default=False,
            key="domestic_hot_water_energy",
            native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
            state_class=SensorStateClass.TOTAL_INCREASING,
            translation_key="domestic_hot_water_energy",
            value=lambda data: cast("float", data),
        ),
        KebaKeEnergySensorEntityDescription(
            device_class=SensorDeviceClass.ENERGY,
            entity_registry_enabled_default=False,
            key="domestic_hot_water_electrical_energy",
            native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
            state_class=SensorStateClass.TOTAL_INCREASING,
            translation_key="domestic_hot_water_electrical_energy",
            value=lambda data: cast("float", data),
        ),
        KebaKeEnergySensorEntityDescription(
            entity_registry_enabled_default=False,
            key="domestic_hot_water_spf",
            state_class=SensorStateClass.MEASUREMENT,
            translation_key="domestic_hot_water_spf",
            value=lambda data: cast("float", data),
        ),
        KebaKeEnergySensorEntityDescription(
            device_class=SensorDeviceClass.ENERGY,
